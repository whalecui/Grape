...
-- for news:
-- first-time, (0)
-- new discuss in group, new reply in group, new vote in group, (1, 2, 3)
-- user deleted from group, discuss deleted by leader, reply deleted by leader, delete group (4, 5, 6, 7)
-- a member quit the group (8)  CHANGE IT!!
